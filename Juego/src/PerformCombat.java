    ...
    public PerformCombat(Multiplex multiplex, Cliente duelista1) {
        ...
        try {
            ...
            if (Multiplex.getClientes().containsKey(duelista2)) {
                ...
                if (Multiplex.getClientes().get(duelista1).getOro() >= oroo { //El oro se coge del jugador del cliente no del cliente en si. Despues del get(duelista) se tiene que coger el personaje y de ahi el getORO
                    this.oro = oroo;
                } else {
